          ...
          <div className="p-5">
            {children.length === 0 ? (
              <p className="text-center text-sm text-white/30 py-8">
                Drag items here to add them to this folder.
              </p>
            ) : (
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                {children.map((item, i) => (
                  <motion.div
                    ...
                    className="group relative flex flex-col items-center gap-2 rounded-xl p-3 transition-colors hover:bg-white/[0.04]"
                  >
                    <button
