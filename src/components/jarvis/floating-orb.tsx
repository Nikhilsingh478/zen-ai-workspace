...
function JarvisIcon({ active }: { active: boolean }) {
  return (
    ...
    >
      ...
      <circle
        cx="10" cy="10" r="8.5"
        stroke={active ? "#93C5FD" : "rgba(125,211,252,0.5)"}
        strokeWidth="1"
      ...
      <circle
        cx="10" cy="10" r="5"
        stroke={active ? "rgba(125,211,252,0.6)" : "rgba(125,211,252,0.25)"}
        strokeWidth="0.8"
      />
      {/* Core */}
      <circle
        cx="10" cy="10" r="2.5"
        fill={active ? "#7DD3FC" : "rgba(125,211,252,0.4)"}
      />
      {/* Cardinal ticks */}
      {[[10, 1.5, 10, 4], [10, 16, 10, 18.5], [1.5, 10, 4, 10], [16, 10, 18.5, 10]].map(([x1, y1, x2, y2], i) => (
        <line
          ...
          stroke={active ? "#93C5FD" : "rgba(125,211,252,0.4)"}
          strokeWidth="1.2"
          strokeLinecap="round"
        />
      ))}
...
function SpinnerArc() {
  return (
    <motion.div
      ...
      style={{ border: "1.5px solid transparent", borderTopColor: "#7DD3FC", borderRightColor: "rgba(125,211,252,0.3)" }}
      animate={{ rotate: 360 }}
      ...
      <div className="relative flex items-center justify-center">
        ...
        <motion.button
          ...
          style={{
            ...
            background: isActive
              ? "radial-gradient(circle at 38% 32%, #93C5FD 0%, #7DD3FC 40%, #121826 100%)"
              : "radial-gradient(circle at 38% 32%, rgba(125,211,252,0.45) 0%, rgba(18,24,38,0.97) 100%)",
            border: `1.5px solid ${isActive ? "rgba(125,211,252,0.75)" : "rgba(125,211,252,0.2)"}`,
            boxShadow: isActive
              ? "0 0 0 1px rgba(125,211,252,0.15), 0 4px 24px rgba(125,211,252,0.45), inset 0 1px 0 rgba(255,255,255,0.12)"
              : "0 0 0 1px rgba(125,211,252,0.08), 0 2px 12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.04)",
            outline: "none",
            cursor: "pointer",
          }}
