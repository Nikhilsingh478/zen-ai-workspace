  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(0,191,255,0.045) 0%, transparent 70%)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-0 z-0"
        style={{
          backgroundImage:
            "radial-gradient(circle, rgba(0,191,255,0.07) 1px, transparent 1px)",
...
function HudCard({ label, children, className }: { label: string; children: React.ReactNode; className?: string }) {
  return (
    ...
    >
      <p className="text-[8px] tracking-[0.28em] font-medium mb-2 uppercase" style={{ color: "rgba(0,191,255,0.32)" }}>
        {label}
      </p>
      {children}
    </div>
      ...
      <HudCard label="QUICK COMMANDS">
        {["What's pending today?", "Open Horizon", "Schedule a meeting", "Open Ask"].map((cmd) => (
          <motion.button
            ...
            style={{ color: "rgba(0,191,255,0.45)", border: "1px solid rgba(0,191,255,0.07)", background: "transparent" }}
            onMouseEnter={(e) => {
  ...
  return (
    ...
    >
      <div
        ...
        style={
          isUser
            ? { background: "rgba(0,191,255,0.09)", border: "1px solid rgba(0,191,255,0.22)", color: "rgba(180,230,255,0.9)" }
            : { background: "rgba(255,255,255,0.03)", border: "1px solid rgba(0,191,255,0.09)", color: "rgba(220,240,255,0.82)" }
        }
      >
        {!isUser && (
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-hidden">
      <div className="flex items-center justify-between mb-3 shrink-0">
        <p className="text-[8px] tracking-[0.28em] font-medium uppercase" style={{ color: "rgba(0,191,255,0.32)" }}>
          Neural Link
        </p>
        {messages.length > 0 && (
          <motion.button
      ...
      <div className="flex-1 min-h-0 overflow-y-auto space-y-2.5 pr-1" style={{ scrollbarWidth: "none" }}>
        <AnimatePresence initial={false}>
          {messages.length === 0 ? (
            ...
            >
              <div className="rounded-full p-3.5" style={{ border: "1px solid rgba(0,191,255,0.1)", background: "rgba(0,191,255,0.04)" }}>
    ...
    <div className="relative h-full flex flex-col overflow-hidden" style={{ background: "var(--background)" }}>
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          />
          <span className="text-[12px] font-bold tracking-[0.22em]" style={{ color: enabled ? "#00BFFF" : "rgba(0,191,255,0.32)" }}>
            J.A.R.V.I.S
          </span>
          <span className="hidden md:block text-[9px] tracking-[0.14em] font-light" style={{ color: "rgba(0,191,255,0.22)" }}>
            ...
            {transcript && (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "0 4px 20px rgba(0,191,255,0.08)",
                }}
              >
                {transcript}
              </motion.div>
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2">
          ...
          <motion.button
            ...
            style={{
              ...
              border: `1px solid ${isListening ? "rgba(0,191,255,0.48)" : "rgba(0,191,255,0.12)"}`,
